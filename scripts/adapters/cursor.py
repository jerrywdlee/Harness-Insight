"""Generic JSONL adapter (cursor / openclaw / antigravity 共通)."""
...
def parse(file_path: str) -> Iterator[dict]:
    ...
    for raw in text.splitlines():
        ...
        yield {
            "ts": obj.get("ts") or obj.get("timestamp") or obj.get("created_at") or (datetime.utcnow().isoformat() + "Z"),
            "actor": actor,
            "action_type": action_type,
            "content": content,
            "meta": {"source": _HARNESS, **(obj.get("meta") or {})},
        }
